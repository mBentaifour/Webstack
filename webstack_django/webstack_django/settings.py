...
INSTALLED_APPS = [
    ...
    'main.apps.MainConfig',  # Notre application principale
    'crispy_forms',
    'crispy_bootstrap4',
    'corsheaders',
    'rest_framework',
...
MIDDLEWARE = [
    ...
    'main.tests.middleware.TestAuthMiddleware',  # Middleware de test
]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'application_name': 'webstack_django',
        },
    }
}
...
# Auth settings
AUTH_USER_MODEL = 'auth.User'  # Utilisation du modèle User par défaut de Django
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'main.authentication.SupabaseAuthentication',
    ],
